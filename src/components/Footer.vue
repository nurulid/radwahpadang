<template lang="">
  <footer>
    <div class="inner container-custom !px-6 lg:!px-0 !py-6 flex justify-between items-center flex-col md:flex-row gap-3 border-t border-graytext text-graytext text-xs">
