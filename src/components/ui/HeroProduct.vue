<template lang="">
  <div v-for="({id, image, name, url, sale}) in data" :key="id" data-aos="zoom-in" data-aos-duration="500" class="bg-white p-3 flex flex-col justify-between group rounded-md relative" v-lazy-container="{ selector: 'img' }">
